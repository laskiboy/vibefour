        ...
        <div class="left marlef w-50 ms-5">
            <div class="mb-5 mt-5 atas">
                <span class="h1 text-black"
                    style="font-family: 'Montserrat'; font-weight: 600; font-size: 4em;">@lang('jadwal.judul')</span><br>
            </div>
            ...
            <div class="tombol">
                ...
                <iframe class="video shadow-lg w-100" style="height: 190px" src="{{ __('jadwal.video') }}"
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            <div class="modal-body d-flex justify-content-center align-items-center">
                                <iframe class="w-100 h-100" src="{{ __('jadwal.video') }}" title="YouTube video player"
                                    frameborder="0"
                                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                    referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                            </div>
